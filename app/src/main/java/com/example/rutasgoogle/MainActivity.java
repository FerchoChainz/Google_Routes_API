package com.example.rutasgoogle;
...
import com.example.rutasgoogle.Utils.Utils;
import com.example.rutasgoogle.other.EnableServices;
import com.example.rutasgoogle.other.GPSTracker;
import com.example.rutasgoogle.other.PermissionGranted;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng we = new LatLng(20.659515376995618, -103.35708713026276);
    ...
    public void ObtenerRuta(String latInicial, String lngInicial, String latFinal, String lngFinal){
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/json?origin=" + latInicial + "," + lngInicial + "&destination=" + latFinal + "," + lngFinal + "&key=AIzaSyCuZamf5-3IYp3wSz3N71pJGWa-JEfVytU&mode=drive";
